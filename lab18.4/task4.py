...
def get_weather(city, api_key=None, timeout=10):
    ...
    Includes basic error handling and prints clear messages for common failures.
    """
    if api_key is None:
    ...
    try:
        ...
        if response.status_code == 404:
            # Match the exact user-facing message requested
        ...
        # Print user-friendly output (as requested)
